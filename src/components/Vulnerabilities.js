...
export const Vulnerabilities = () => (
  <section id="vulnerabilities">
    <Container>
      <h2 className="navpad">Vulnerability Disclosures</h2>
      ...
      <p>
        ...
        Vodafone's mobile app API allows viewing bills via their bill ID.
        One could log in with a separate account where the PIN is known and request the other user's bill, allowing reading their bill without needing to enter a PIN.
